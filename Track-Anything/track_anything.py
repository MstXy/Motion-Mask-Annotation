...
def parse_augment():
    ...
    parser.add_argument('--kittidir', default="/home/zcy/data/win_id4_share/KITTI")
    parser.add_argument('--outputdir', default="/home/zcy/data/4t_data/Track-anything-data/kitti-after-ta")
